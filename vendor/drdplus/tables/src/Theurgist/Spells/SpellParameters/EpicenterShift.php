...
{
    private ?\DrdPlus\Tables\Measurements\Distance\Distance $distance = null;
    private ?\DrdPlus\Tables\Measurements\Distance\DistanceBonus $distanceBonus = null;
    ...
    {
        return $this->distance ?? $this->getDistanceBonus()->getDistance();
    }
