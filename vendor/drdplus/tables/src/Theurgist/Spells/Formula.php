...
class Formula extends StrictObject
{
    ...
    private \DrdPlus\Codes\Theurgist\FormulaCode $formulaCode;
    private \DrdPlus\Tables\Tables $tables;
    /** @var int[] */
    private array $formulaSpellParameterChanges;
    /** @var Modifier[] */
    private $modifiers;
    /** @var SpellTrait[] */
    private array $formulaSpellTraits;
