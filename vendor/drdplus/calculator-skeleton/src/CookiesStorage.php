...
class CookiesStorage extends StrictObject implements StorageInterface
{
    ...
    public function storeValues(array $values, ?\DateTimeInterface $cookiesTtlDateTime): void
    {
        $this->cookiesService->setCookie($this->storageKey, \serialize($values), false, $cookiesTtlDateTime);
        $this->values = $values;
    }
