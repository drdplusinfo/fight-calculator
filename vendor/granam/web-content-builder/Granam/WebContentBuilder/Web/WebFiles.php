...
{
    /** @var SourceDirProviderInterface */
    private $sourceDirProvider;

    public function __construct(SourceDirProviderInterface $sourceDirProvider)
    {
    ...
    {
        return $this->sourceDirProvider->getSourceDir();
    }
